...
class ArmRobot:
    ...
    def __del__(self):
        ...
        rospy.loginfo('\033[95m' + "Object of class ArmRobot Deleted." + '\033[0m')
def main():

    #Create a new arm object from the ArmRobot class
    arm = ArmRobot("arm_group")
    hand =  ArmRobot("gripper_group")
    ...
    arm.set_pose("start_pose")
    rospy.sleep(1)

    #Open the gripper or end effector
    hand.set_pose("gripper_open")
    rospy.sleep(1)
    ...
    while not rospy.is_shutdown():
        ...
        #Go to drop Object Pre-Pose
        arm.set_pose("opposite_pose")
        rospy.sleep(1)

        #Go to drop  Object Pose
        arm.set_pose("drop_object_pose_1")
        rospy.sleep(1)
